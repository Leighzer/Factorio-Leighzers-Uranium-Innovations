...
if not leighzermods.leighzeruraniuminnovations then
    ...
    leighzermods.leighzeruraniuminnovations.beltSpeed = 0.03125 * 5 -- 5x regular belt speed 75/s 4500/min
    leighzermods.leighzeruraniuminnovations.undergroundBeltMaxLength = 11 -- following pattern 5, 7, 9, => 11 for reg, fast, express => uranium
end
