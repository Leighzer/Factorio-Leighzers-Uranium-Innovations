...
require("prototypes.assemblerpipes")

function uranium_electric_mining_drill_animation()
  return
  {
    priority = "high",
    filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/electric-mining-drill.png",
    line_length = 6,
    width = 84,
    height = 80,
    frame_count = 30,
    ...
    {
      priority = "high",
      filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/hr-electric-mining-drill.png",
      line_length = 6,
      width = 162,
      height = 156,
      frame_count = 30,
...
function uranium_electric_mining_drill_horizontal_animation()
  return
  {
    priority = "high",
    filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/electric-mining-drill-horizontal.png",
    line_length = 6,
    width = 40,
    height = 80,
    frame_count = 30,
    ...
    {
      priority = "high",
      filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/hr-electric-mining-drill-horizontal.png",
      line_length = 6,
      width = 80,
      height = 160,
      frame_count = 30,
...
function uranium_electric_mining_drill_horizontal_front_animation()
  return
  {
    priority = "high",
    filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/electric-mining-drill-horizontal-front.png",
    line_length = 6,
    width = 32,
    height = 76,
    frame_count = 30,
    ...
    {
      priority = "high",
      filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/hr-electric-mining-drill-horizontal-front.png",
      line_length = 6,
      width = 66,
      height = 154,
      frame_count = 30,
...
data:extend({
    {
        type = "item",
        name = "uranium-electric-mining-drill",
        icon = "__leighzeruraniuminnovations__/graphics/icons/electric-mining-drill.png",
        icon_size = 64, icon_mipmaps = 4,
        subgroup = "extraction-machine",
        order = "a[items]-b[uranium-electric-mining-drill]",
        place_result = "uranium-electric-mining-drill",
        stack_size = 50
    }, -- item
    {
        type = "recipe",
          ...
          animation =
          {
            north =
            {
              layers =
              {
                {
                  priority = "high",
                  filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/electric-mining-drill-N.png",
                  line_length = 1,
                  width = 96,
                  height = 104,
                  frame_count = 1,
                  ...
                  {
                    priority = "high",
                    filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/hr-electric-mining-drill-N.png",
                    line_length = 1,
                    width = 190,
                    height = 208,
                    frame_count = 1,
                ...
                {
                  priority = "high",
                  filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/electric-mining-drill-N-output.png",
                  line_length = 5,
                  width = 32,
                  height = 34,
                  frame_count = 5,
                  ...
                  {
                    priority = "high",
                    filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/hr-electric-mining-drill-N-output.png",
                    line_length = 5,
                    width = 60,
                    height = 66,
                    frame_count = 5,
            ...
            east =
            {
              layers =
              {
                {
                  priority = "high",
                  filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/electric-mining-drill-E.png",
                  line_length = 1,
                  width = 96,
                  height = 94,
                  frame_count = 1,
                  ...
                  {
                    priority = "high",
                    filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/hr-electric-mining-drill-E.png",
                    line_length = 1,
                    width = 192,
                    height = 188,
                    frame_count = 1,
                ...
                {
                  priority = "high",
                  filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/electric-mining-drill-E-output.png",
                  line_length = 5,
                  width = 26,
                  height = 38,
                  frame_count = 5,
                  ...
                  {
                    priority = "high",
                    filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/hr-electric-mining-drill-E-output.png",
                    line_length = 5,
                    width = 50,
                    height = 74,
                    frame_count = 5,
            ...
            south =
            {
              layers =
              {
                {
                  priority = "high",
                  filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/electric-mining-drill-S.png",
                  line_length = 1,
                  width = 92,
                  height = 98,
                  frame_count = 1,
                  ...
                  {
                    priority = "high",
                    filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/hr-electric-mining-drill-S.png",
                    line_length = 1,
                    width = 184,
                    height = 192,
                    frame_count = 1,
            ...
            west =
            {
              layers =
              {
                {
                  priority = "high",
                  filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/electric-mining-drill-W.png",
                  line_length = 1,
                  width = 96,
                  height = 94,
                  frame_count = 1,
                  ...
                  {
                    priority = "high",
                    filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/hr-electric-mining-drill-W.png",
                    line_length = 1,
                    width = 192,
                    height = 188,
                    frame_count = 1,
                ...
                {
                  priority = "high",
                  filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/electric-mining-drill-W-output.png",
                  line_length = 5,
                  width = 24,
                  height = 28,
                  frame_count = 5,
                  ...
                  {
                    priority = "high",
                    filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/hr-electric-mining-drill-W-output.png",
                    line_length = 5,
                    width = 50,
                    height = 60,
                    frame_count = 5,
          ...
          working_visualisations =
          {
            ...
            -- drill back animation
            {
              ...
              north_animation =
              {
                layers =
                {
                  uranium_electric_mining_drill_animation(),
              ...
              east_animation =
              {
                layers =
                {
                  uranium_electric_mining_drill_horizontal_animation(),
            ...
            -- drill front animation
            {
              ...
              east_animation = uranium_electric_mining_drill_horizontal_front_animation(),
              --south_animation = util.empty_sprite(),
              west_animation = uranium_electric_mining_drill_horizontal_front_animation()
            },
            ...
            -- front frame
            {
              ...
              {
                priority = "high",
                filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/electric-mining-drill-E-front.png",
                line_length = 1,
                width = 66,
                height = 74,
                frame_count = 1,
                ...
                {
                  priority = "high",
                  filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/hr-electric-mining-drill-E-front.png",
                  line_length = 1,
                  width = 136,
                  height = 148,
                  frame_count = 1,
              ...
              south_animation =
              {
                layers =
                {
                  {
                    priority = "high",
                    filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/electric-mining-drill-S-output.png",
                    line_length = 5,
                    width = 44,
                    height = 28,
                    frame_count = 5,
                    ...
                    {
                      priority = "high",
                      filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/hr-electric-mining-drill-S-output.png",
                      line_length = 5,
                      width = 84,
                      height = 56,
                      frame_count = 5,
                  ...
                  {
                    priority = "high",
                    filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/electric-mining-drill-S-front.png",
                    line_length = 1,
                    width = 96,
                    height = 54,
                    frame_count = 1,
                    ...
                    {
                      priority = "high",
                      filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/hr-electric-mining-drill-S-front.png",
                      line_length = 1,
                      width = 190,
                      height = 104,
                      frame_count = 1,
              ...
              {
                priority = "high",
                filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/electric-mining-drill-W-front.png",
                line_length = 1,
                width = 68,
                height = 70,
                frame_count = 1,
                ...
                {
                  priority = "high",
                  filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/hr-electric-mining-drill-W-front.png",
                  line_length = 1,
                  width = 134,
                  height = 140,
                  frame_count = 1,
          ...
          animation =
          {
            north =
            {
              layers =
              {
                {
                  priority = "high",
                  filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/electric-mining-drill-N-wet.png",
                  line_length = 1,
                  width = 96,
                  height = 100,
                  frame_count = 1,
                  ...
                  {
                    priority = "high",
                    filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/hr-electric-mining-drill-N-wet.png",
                    line_length = 1,
                    width = 190,
                    height = 198,
                    frame_count = 1,
            ...
            west =
            {
              layers =
              {
                {
                  priority = "high",
                  filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/electric-mining-drill-W-wet.png",
                  line_length = 1,
                  width = 96,
                  height = 106,
                  frame_count = 1,
                  ...
                  {
                    priority = "high",
                    filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/hr-electric-mining-drill-W-wet.png",
                    line_length = 1,
                    width = 194,
                    height = 208,
                    frame_count = 1,
            ...
            south =
            {
              layers =
              {
                {
                  priority = "high",
                  filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/electric-mining-drill-S-wet.png",
                  line_length = 1,
                  width = 98,
                  height = 106,
                  frame_count = 1,
                  ...
                  {
                    priority = "high",
                    filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/hr-electric-mining-drill-S-wet.png",
                    line_length = 1,
                    width = 192,
                    height = 208,
                    frame_count = 1,
            ...
            east =
            {
              layers =
              {
                {
                  priority = "high",
                  filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/electric-mining-drill-E-wet.png",
                  line_length = 1,
                  width = 98,
                  height = 106,
                  frame_count = 1,
                  ...
                  {
                    priority = "high",
                    filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/hr-electric-mining-drill-E-wet.png",
                    line_length = 1,
                    width = 194,
                    height = 208,
                    frame_count = 1,
            ...
            -- front frame (wet)
            {
              ...
              north_animation =
              {
                layers =
                {
                  {
                    priority = "high",
                    filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/electric-mining-drill-N-wet-front.png",
                    line_length = 1,
                    width = 100,
                    height = 66,
                    frame_count = 1,
                    ...
                    {
                      priority = "high",
                      filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/hr-electric-mining-drill-N-wet-front.png",
                      line_length = 1,
                      width = 200,
                      height = 130,
                      frame_count = 1,
              ...
              west_animation =
              {
                layers =
                {
                  {
                    priority = "high",
                    filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/electric-mining-drill-W-wet-front.png",
                    line_length = 1,
                    width = 104,
                    height = 72,
                    frame_count = 1,
                    ...
                    {
                      priority = "high",
                      filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/hr-electric-mining-drill-W-wet-front.png",
                      line_length = 1,
                      width = 208,
                      height = 144,
                      frame_count = 1,
              ...
              south_animation =
              {
                layers =
                {
                  ...
                  {
                    priority = "high",
                    filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/electric-mining-drill-S-wet-front.png",
                    line_length = 1,
                    width = 96,
                    height = 70,
                    frame_count = 1,
                    ...
                    {
                      priority = "high",
                      filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/hr-electric-mining-drill-S-wet-front.png",
                      line_length = 1,
                      width = 192,
                      height = 140,
                      frame_count = 1,
              ...
              east_animation =
              {
                layers =
                {
                  {
                    priority = "high",
                    filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/electric-mining-drill-E-wet-front.png",
                    line_length = 1,
                    width = 106,
                    height = 76,
                    frame_count = 1,
                    ...
                    {
                      priority = "high",
                      filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/hr-electric-mining-drill-E-wet-front.png",
                      line_length = 1,
                      width = 208,
                      height = 148,
                      frame_count = 1,
    ...
    {
      type = "corpse",
      name = "uranium-electric-mining-drill-remnants",
      icon = "__leighzeruraniuminnovations__/graphics/icons/electric-mining-drill.png",
      icon_size = 64, icon_mipmaps = 4,
      ...
      {
        filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/remnants/electric-mining-drill-remnants.png",
        line_length = 1,
        width = 178,
        height = 166,
        frame_count = 1,
        ...
        hr_version =
        {
          filename = "__leighzeruraniuminnovations__/graphics/entity/electric-mining-drill/remnants/hr-electric-mining-drill-remnants.png",
          line_length = 1,
          width = 356,
          height = 328,
          frame_count = 1,
