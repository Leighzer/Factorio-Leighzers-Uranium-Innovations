...
data:extend({
    ...
    }, -- item
    {
      ...
      }, -- recipe
      {
        ...
        max_health = leighzermods.leighzeruraniuminnovations.logisticRobot.maxHealth, -- 100,
        ...
        max_payload_size = 1,
        speed = leighzermods.leighzeruraniuminnovations.logisticRobot.speed, -- 0.05,
        max_energy = leighzermods.leighzeruraniuminnovations.logisticRobot.maxEnergy, -- "1.5MJ",
        energy_per_tick = leighzermods.leighzeruraniuminnovations.logisticRobot.energyPerTick, -- "0.05kJ",
        speed_multiplier_when_out_of_energy = leighzermods.leighzeruraniuminnovations.logisticRobot.speedMultiplierWhenOutOfEnergy, -- 0.2,
        energy_per_move = leighzermods.leighzeruraniuminnovations.logisticRobot.energyPerMove, -- "5kJ",
        min_to_charge = leighzermods.leighzeruraniuminnovations.logisticRobot.minToCharge, -- 0.2,
        max_to_charge = leighzermods.leighzeruraniuminnovations.logisticRobot.maxToCharge, -- 0.95,
